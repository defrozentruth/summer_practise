...
package com.example.astar.databinding;
...
public final class ActivityFullscreenBinding implements ViewBinding {
  ...
  private ActivityFullscreenBinding(@NonNull FrameLayout rootView, @NonNull Button button) {
  ...
  public static ActivityFullscreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFullscreenBinding((FrameLayout) rootView, button);
    }
